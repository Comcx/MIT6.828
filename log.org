...
**** NEXT Loading the *kernel*
***** NEXT [0/2] [Exercise 4] Review basics of C programming
****** NEXT [book] *The C Programming Language*
****** TODO Test with /pointers.c/

***** TODO Learning *ELF* format
