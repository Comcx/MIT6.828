...
typedef enum {
    ...
    TRACE_VFIO_EOI,
    TRACE_VFIO_ENABLE_INTX_KVM,
    TRACE_VFIO_DISABLE_INTX_KVM,
    TRACE_VFIO_UPDATE_IRQ,
    TRACE_VFIO_ENABLE_INTX,
    TRACE_VFIO_DISABLE_INTX,
    TRACE_VFIO_MSI_INTERRUPT,
    TRACE_VFIO_MSIX_VECTOR_DO_USE,
    TRACE_VFIO_MSIX_VECTOR_RELEASE,
    TRACE_VFIO_ENABLE_MSIX,
    TRACE_VFIO_ENABLE_MSI,
    TRACE_VFIO_DISABLE_MSIX,
    TRACE_VFIO_DISABLE_MSI,
    TRACE_VFIO_PCI_LOAD_ROM,
    TRACE_VFIO_ROM_READ,
    TRACE_VFIO_PCI_SIZE_ROM,
    TRACE_VFIO_VGA_WRITE,
    TRACE_VFIO_VGA_READ,
    TRACE_VFIO_GENERIC_WINDOW_QUIRK_READ,
    TRACE_VFIO_GENERIC_WINDOW_QUIRK_WRITE,
    TRACE_VFIO_GENERIC_QUIRK_READ,
    TRACE_VFIO_GENERIC_QUIRK_WRITE,
    TRACE_VFIO_ATI_3C3_QUIRK_READ,
    TRACE_VFIO_VGA_PROBE_ATI_3C3_QUIRK,
    TRACE_VFIO_PROBE_ATI_BAR4_WINDOW_QUIRK,
    ...
    TRACE_VFIO_PROBE_RTL8168_BAR2_WINDOW_QUIRK,
    TRACE_VFIO_PROBE_ATI_BAR2_4000_QUIRK,
    TRACE_VFIO_NVIDIA_3D0_QUIRK_READ,
    TRACE_VFIO_NVIDIA_3D0_QUIRK_WRITE,
    TRACE_VFIO_VGA_PROBE_NVIDIA_3D0_QUIRK,
    TRACE_VFIO_PROBE_NVIDIA_BAR5_WINDOW_QUIRK,
    TRACE_VFIO_PROBE_NVIDIA_BAR0_88000_QUIRK,
    TRACE_VFIO_PROBE_NVIDIA_BAR0_1800_QUIRK_ID,
    TRACE_VFIO_PROBE_NVIDIA_BAR0_1800_QUIRK,
    TRACE_VFIO_PCI_READ_CONFIG,
    TRACE_VFIO_PCI_WRITE_CONFIG,
    TRACE_VFIO_SETUP_MSI,
    TRACE_VFIO_EARLY_SETUP_MSIX,
    ...
    TRACE_VFIO_POPULATE_DEVICE_REGION,
...
#define TRACE_QEMU_DMA_ACCEPT_INCOMING_MIGRATION_ENABLED 1
#define TRACE_QEMU_DMA_ACCEPT_INCOMING_MIGRATION_ACCEPTED_ENABLED 1
...
#define TRACE_VFIO_EOI_ENABLED 1
#define TRACE_VFIO_ENABLE_INTX_KVM_ENABLED 1
#define TRACE_VFIO_DISABLE_INTX_KVM_ENABLED 1
#define TRACE_VFIO_UPDATE_IRQ_ENABLED 1
#define TRACE_VFIO_ENABLE_INTX_ENABLED 1
#define TRACE_VFIO_DISABLE_INTX_ENABLED 1
...
#define TRACE_VFIO_ENABLE_MSIX_ENABLED 1
#define TRACE_VFIO_ENABLE_MSI_ENABLED 1
#define TRACE_VFIO_DISABLE_MSIX_ENABLED 1
#define TRACE_VFIO_DISABLE_MSI_ENABLED 1
...
#define TRACE_VFIO_GENERIC_WINDOW_QUIRK_READ_ENABLED 1
#define TRACE_VFIO_GENERIC_WINDOW_QUIRK_WRITE_ENABLED 1
#define TRACE_VFIO_GENERIC_QUIRK_READ_ENABLED 1
#define TRACE_VFIO_GENERIC_QUIRK_WRITE_ENABLED 1
#define TRACE_VFIO_ATI_3C3_QUIRK_READ_ENABLED 1
#define TRACE_VFIO_VGA_PROBE_ATI_3C3_QUIRK_ENABLED 1
#define TRACE_VFIO_PROBE_ATI_BAR4_WINDOW_QUIRK_ENABLED 1
#define TRACE_VFIO_RTL8168_WINDOW_QUIRK_READ_FAKE_ENABLED 1
#define TRACE_VFIO_RTL8168_WINDOW_QUIRK_READ_TABLE_ENABLED 1
#define TRACE_VFIO_RTL8168_WINDOW_QUIRK_READ_DIRECT_ENABLED 1
#define TRACE_VFIO_RTL8168_WINDOW_QUIRK_WRITE_TABLE_ENABLED 1
#define TRACE_VFIO_RTL8168_WINDOW_QUIRK_WRITE_DIRECT_ENABLED 1
#define TRACE_VFIO_PROBE_RTL8168_BAR2_WINDOW_QUIRK_ENABLED 1
#define TRACE_VFIO_PROBE_ATI_BAR2_4000_QUIRK_ENABLED 1
#define TRACE_VFIO_NVIDIA_3D0_QUIRK_READ_ENABLED 1
#define TRACE_VFIO_NVIDIA_3D0_QUIRK_WRITE_ENABLED 1
#define TRACE_VFIO_VGA_PROBE_NVIDIA_3D0_QUIRK_ENABLED 1
#define TRACE_VFIO_PROBE_NVIDIA_BAR5_WINDOW_QUIRK_ENABLED 1
#define TRACE_VFIO_PROBE_NVIDIA_BAR0_88000_QUIRK_ENABLED 1
#define TRACE_VFIO_PROBE_NVIDIA_BAR0_1800_QUIRK_ID_ENABLED 1
#define TRACE_VFIO_PROBE_NVIDIA_BAR0_1800_QUIRK_ENABLED 1
#define TRACE_VFIO_PCI_READ_CONFIG_ENABLED 1
#define TRACE_VFIO_PCI_WRITE_CONFIG_ENABLED 1
#define TRACE_VFIO_SETUP_MSI_ENABLED 1
#define TRACE_VFIO_EARLY_SETUP_MSIX_ENABLED 1
...
#define TRACE_VFIO_POPULATE_DEVICE_REGION_ENABLED 1
